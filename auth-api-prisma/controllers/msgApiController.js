...
// const { logMessage } = require('../services/msgLogService');
...
//     const newApi = await prisma.msg_apis.create({
...
//       message: 'Messaging API Added Successfully'
//     });
//   } catch (err) {
//     console.error(err);
//     res.status(500).json({
...
//       message: 'Failed to add Messaging API'
//     });
//   }
// };
...
// // List APIs with pagination & filters
// exports.getMsgApiList = async (req, res) => {
//   const offset = parseInt(req.body.offset) || 0;
//   const limit = parseInt(req.body.limit) || 10;
//   const searchValue = req.body.searchValue || '';
//   const apiType = req.body.api_type; // "SMS", "Whatsapp", or null
//   const statusFilter = req.body.status; // "active", "inactive", or null

//   try {
//     const where = {
//       AND: [
//         searchValue
//           ? { api_name: { contains: searchValue, mode: 'insensitive' } }
//           : null,
//         apiType && apiType !== 'All'
//           ? { api_type: apiType }
//           : null,
...
//   try {
//     const api = await prisma.msg_apis.findUnique({ where: { id: Number(id) } });
//     if (!api) {
//       return res.status(404).json({
//         success: false,
//         statusCode: RESPONSE_CODES.NOT_FOUND,
...
//     const duplicateName = await prisma.msg_apis.findFirst({
//       where: {
...
//         success: false,
//         statusCode: RESPONSE_CODES.DUPLICATE,
//         message: 'Another Messaging API with the same name exists'
//       });
//     }
...
//       success: true,
//       statusCode: RESPONSE_CODES.SUCCESS,
//       message: 'Messaging API updated successfully'
//     });
//   } catch (err) {
//     console.error(err);
//     res.status(500).json({
...
//       success: true,
//       statusCode: RESPONSE_CODES.SUCCESS,
//       message: 'Messaging API deleted successfully'
//     });
//   } catch (err) {
//     console.error(err);
//     res.status(404).json({
